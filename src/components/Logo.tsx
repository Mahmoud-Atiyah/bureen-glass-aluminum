...
export function Logo() {
  return (
    ...
    >
      <span className="relative grid h-10 w-10 place-items-center rounded-full glass-panel glass-sheen">
        <Image src="/brand/logo.png" alt="Bureen Glass and Aluminum" width={32} height={32} priority />
      </span>
      <span className="leading-tight">
        ...
        <span className="block text-[11px] font-semibold text-zinc-500">Glass & Aluminum</span>
      </span>
    </Link>
  );
}
